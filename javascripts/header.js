(function(window, undefined) {
  document.write('<div id="header"><nav>'
    ...
    + '<li class="fork"><a href="http://wang-bin.github.io/QtAV"><span class="fa fa-home"></span> Home</a></li>'
    + '<li class="downloads"><a href="http://www.qtav.org/install.html"><span class="fa fa-cloud-download"></span> Install</a></li>'
